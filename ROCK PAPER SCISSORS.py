...
lblimage = PhotoImage(file='C:\\Users\\hya\\AppData\\Local\\Programs\\Python\\Python37-32\\Stress\\bugatti.png')
lblimage = PhotoImage(file='C:\\Users\\hya\\AppData\\Local\\Programs\\Python\\Python37-32\\Stress\\chevrolet.png')
lblimage = PhotoImage(file='C:\\Users\\hya\\AppData\\Local\\Programs\\Python\\Python37-32\\Stress\\lamborghini.png')
Button(stem, text="Press Start ", width=10, command=mainscreen).grid(row=7, column=0, sticky=S)
...
Label(stem, text="Welcome To The game", bg="black",fg="aqua",
      font="none 20 bold"). grid(row=1, column =4, sticky=N)
